...
barplot_layout2 = BarPlotLayout(fill_color='red', column=1)
barplot_layout3 = BarPlotLayout(fill_color='yellow', column=2)
# Explore tree with the new barplot layout
t.explore(layouts=[BASIC_LAYOUT, barplot_layout, barplot_layout2, barplot_layout3])
